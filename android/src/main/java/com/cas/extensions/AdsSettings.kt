...
fun AdsSettings.toReadableMap(): com.facebook.react.bridge.ReadableMap {
...
fun AdsSettings.fromReadableMap(map: ReadableMap) {
  ...
  map.has("allowInterstitialAdsWhenVideoCostAreLower") { this.allowInterstitialAdsWhenVideoCostAreLower = map.getBoolean("allowInterstitialAdsWhenVideoCostAreLower") }
  map.has("bannerRefreshInterval") { this.bannerRefreshInterval = map.getInt("bannerRefreshInterval") }
  map.has("interstitialInterval") { this.interstitialInterval = map.getInt("interstitialInterval") }
  ...
  map.has("deprecated_analyticsCollectionEnabled") { this.analyticsCollectionEnabled = map.getBoolean("deprecated_analyticsCollectionEnabled") }
