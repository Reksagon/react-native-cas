...
//
//@interface CASAdViewUIComponent()<MAAdViewAdDelegate, MAAdRevenueDelegate>
//
//@property (nonatomic, strong) MAAdView *adView;
//
//@property (nonatomic, weak, nullable) CASAdView *containerView;
//
//@end
//
...
//}
//
//- (void)attachAdView:(CASAdView *)view
//{
...
//    [body addEntriesFromDictionary: [[CAS shared] adInfoForAd: ad]];
//    
//    if ( [CASAdView hasPreloadedAdViewForIdentifier: @(self.hash)] )
//    {
//        [[CAS shared] sendEventWithName: ON_NATIVE_UI_COMPONENT_ADVIEW_AD_LOADED_EVENT body: body];
//    }
//    
...
//{
//    NSMutableDictionary *body = [@{@"adViewId": @(self.hash)} mutableCopy];
//    [body addEntriesFromDictionary: [[CAS shared] adLoadFailedInfoForAd: adUnitIdentifier withError: error]];
//    
//    if ( [CASAdView hasPreloadedAdViewForIdentifier: @(self.hash)] )
//    {
//        [[CAS shared] sendEventWithName: ON_NATIVE_UI_COMPONENT_ADVIEW_AD_LOAD_FAILED_EVENT body: body];
//    }
//    
//    if ( self.containerView )
//    {
...
//    {
//        NSMutableDictionary *body = [@{@"adViewId": @(self.hash)} mutableCopy];
//        [body addEntriesFromDictionary: [[CAS shared] adDisplayFailedInfoForAd: ad withError: error]];
//        
